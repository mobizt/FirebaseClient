...
public:
    ...
    public:
        ...
        async_request_data_t(AsyncClient *aClient, const String &path, async_request_handler_t::http_request_method method, slot_options_t opt, DataOptions *options, file_config_data *file, AsyncResult *aResult, AsyncResultCallback cb)
        {
