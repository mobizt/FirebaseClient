...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        cfunctions.setIamPolicy(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION, STORAGE_BUCKET_ID), "helloWorld" /* function name */, options, asyncCB);

        // To assign UID for async result
        // cfunctions.setIamPolicy(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION, STORAGE_BUCKET_ID), "helloWorld", options, asyncCB, "myUID");

        // To get anyc result without callback
        // cfunctions.setIamPolicy(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION, STORAGE_BUCKET_ID), "helloWorld", options, aResult_no_callback);
    }
}
