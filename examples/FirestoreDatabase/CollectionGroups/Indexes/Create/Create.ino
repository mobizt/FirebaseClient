 ...
 * SYNTAXES:
 *
 * indexes.create(<AsyncClient>, <ParentResource>, <collectionId>, <Index>);
 * indexes.create(<AsyncClient>, <ParentResource>, <collectionId>, <Index>, <AsyncResult>);
 * indexes.create(<AsyncClient>, <ParentResource>, <collectionId>, <Index>, <AsyncResultCallback>, <uid>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        indexes.create(aClient, ParentResource(FIREBASE_PROJECT_ID), collectionId, index, asyncCB);

        // To assign UID for async result
        // indexes.create(aClient, ParentResource(FIREBASE_PROJECT_ID), collectionId, index, asyncCB, "myUID");

        // To get anyc result without callback
        // indexes.create(aClient, ParentResource(FIREBASE_PROJECT_ID), collectionId, index, aResult_no_callback);
    }
}
