 ...
 * SYNTAXES:
 *
 * indexes.get(<AsyncClient>, <Firestore::Parent>, <indexId>);
 * indexes.get(<AsyncClient>, <Firestore::Parent>, <indexId>, <AsyncResult>);
 * indexes.get(<AsyncClient>, <Firestore::Parent>, <indexId>, <AsyncResultCallback>, <uid>);
 *
