 ...
 * SYNTAXES:
 *
 * indexes.get(<AsyncClient>, <ParentResource>, <Index>);
 * indexes.get(<AsyncClient>, <ParentResource>, <Index>, <AsyncResult>);
 * indexes.get(<AsyncClient>, <ParentResource>, <Index>, <AsyncResultCallback>, <uid>);
 *
