...
void loop()
{
    ...
    // 17. Checking the authentication status before calling Firebase services API.
    // ============================================================================
    ...
    // 18. Processing the result from async tasks.
    // ===========================================
    printResult(myResult);
}

// 19. Defined the auxiliary function required to get the timestamp for internal JWT token signing process.
// ========================================================================================================.
void timeStatusCB(uint32_t &ts)
{
...
// 22 The auxiliary function to create the message to send.
// ========================================================
void getMsg(Messages::Message &msg)
{
    msg.topic("test");
