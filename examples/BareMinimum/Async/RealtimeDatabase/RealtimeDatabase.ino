/**
 * The beare minimum code example for Realtime Database in async mode.
 */
...
void loop()
{
    // 13. Place the FirebaseApp class object in Step 5 in the loop (always)
    app.loop();

    // 14. Place the Firebase service class in the loop.
...
// 16. The callback function that will be called when the information/error/data from the auth and Firebase processes are available.
