...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        firestore.importDocuments(aClient, ParentResource(FIREBASE_PROJECT_ID), "" /* Which collection ids to export. Unspecified means all collections. */, STORAGE_BUCKET_ID, "test_path" /* The path in the Firebase Storage bucket that store the exported data */, asyncCB);
