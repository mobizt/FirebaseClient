...
void loop()
{
    ...
    if (app.ready() && (millis() - dataMillis > 60000 || dataMillis == 0))
    {
        ...
        // firestore.commitDocument(aClient, ParentResource(FIREBASE_PROJECT_ID), writes, asyncCB, "myUID");

        // To get anyc result without callback
        // firestore.commitDocument(aClient, ParentResource(FIREBASE_PROJECT_ID), writes, aResult_no_callback);
    }
}
