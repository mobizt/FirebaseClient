 ...
 * SYNTAXES:
 *
 * firestore.runQuery(<AsyncClient>, <ParentResource>, <documentPath>, <QueryOptions>);
 * firestore.runQuery(<AsyncClient>, <ParentResource>, <documentPath>, <QueryOptions>, <AsyncResult>);
 * firestore.runQuery(<AsyncClient>, <ParentResource>, <documentPath>, <QueryOptions>, <AsyncResultCallback>, <uid>);
 *
...
void loop()
{
    ...
    if (app.ready() && (millis() - dataMillis > 60000 || dataMillis == 0))
    {
        ...
        // firestore.runQuery(aClient, ParentResource(FIREBASE_PROJECT_ID), documentPath, queryOptions, asyncCB, "myUID");

        // To get anyc result without callback
        // firestore.runQuery(aClient, ParentResource(FIREBASE_PROJECT_ID), documentPath, queryOptions, aResult_no_callback);
    }
}
