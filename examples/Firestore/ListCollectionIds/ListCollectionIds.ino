...
/**
 * LIST COLLECTION IDS FUNCTIONS
 * =============================
 *
 * SYNTAXES:
 *
 * firestore.listCollectionIds(<AsyncClient>, <ParentResource>, <ListCollectionIdsOptions>);
 * firestore.listCollectionIds(<AsyncClient>, <ParentResource>, <ListCollectionIdsOptions>, <AsyncResult>);
 * firestore.listCollectionIds(<AsyncClient>, <ParentResource>, <ListCollectionIdsOptions>, <AsyncResultCallback>, <uid>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        firestore.listCollectionIds(aClient, ParentResource(FIREBASE_PROJECT_ID), documentPath, listCollectionIdsOptions, asyncCB);

        // To assign UID for async result
        // firestore.listCollectionIds(aClient, ParentResource(FIREBASE_PROJECT_ID), documentPath, listCollectionIdsOption, asyncCB, "myUID");

        // To get anyc result without callback
        // firestore.listCollectionIds(aClient, ParentResource(FIREBASE_PROJECT_ID), documentPath, listCollectionIdsOption, aResult_no_callback);
    }
}
