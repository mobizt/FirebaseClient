...
/**
 * BATCH GET DOCUMENTS FUNCTIONS
 * =============================
 *
 * SYNTAXES:
 *
 * firestore.batchGetDocuments(<AsyncClient>, <ParentResource>, <BatchGetDocumentOptions>);
 * firestore.batchGetDocuments(<AsyncClient>, <ParentResource>, <BatchGetDocumentOptions>, <AsyncResult>);
 * firestore.batchGetDocuments(<AsyncClient>, <ParentResource>, <BatchGetDocumentOptions>, <AsyncResultCallback>, <uid>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        firestore.batchGetDocuments(aClient, ParentResource(FIREBASE_PROJECT_ID), options, asyncCB);

        // To assign UID for async result
        // firestore.batchGetDocuments(aClient, ParentResource(FIREBASE_PROJECT_ID), options, asyncCB, "myUID");

        // To get anyc result without callback
        // firestore.batchGetDocuments(aClient, ParentResource(FIREBASE_PROJECT_ID), options, aResult_no_callback);
    }
}
